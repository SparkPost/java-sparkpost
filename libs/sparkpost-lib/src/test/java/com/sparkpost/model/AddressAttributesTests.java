...
public class AddressAttributesTests {
	...
	private String SIMPLE_ADDRESS_JSON = "{" + 
	...
	public void testSimpleDecodeAddress() {
		Gson gson = new Gson();
		AddressAttributes addressAttributes = gson.fromJson(SIMPLE_ADDRESS_JSON, AddressAttributes.class);
	...
	public void testSimpleDecodeAddress_2() {
		Gson gson = new Gson();
		AddressAttributes addressAttributes = gson.fromJson(SIMPLE_ADDRESS_JSON_2, AddressAttributes.class);
