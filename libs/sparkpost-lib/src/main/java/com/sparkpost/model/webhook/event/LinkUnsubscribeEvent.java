...
public class LinkUnsubscribeEvent extends AbstractWebhookEvent {
    ...
    @Description(value = "Envelope mailfrom of the original email", sample = "recipient@example.com")
    private String mailfrom;

    @Description(value = "Type of event this record describes", sample = "link_unsubscribe")
    private String type;
