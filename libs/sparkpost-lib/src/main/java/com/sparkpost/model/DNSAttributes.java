...
public class DNSAttributes extends Base {
	 ...
	 */
	@Description(value="DNS DKIM record for the registered Sending Domain")
	 ...
	 */
	@Description(value="DNS SPF record for the registered Sending Domain")
	 ...
	 */
	@Description(value="Error message describing reason for DKIM verification failure")
	 ...
	 */
	@Description(value="Error message describing reason for SPF verification failure")
