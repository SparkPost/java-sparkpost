...
public class ClickEvent extends AbstractWebhookEvent {
    ...
    @Description(value = "Type of event this record describes", sample = "click")
    private String type;
    ...
    @Description(value = "Name of the link for which a click event was generated", sample = "Example Link Name")
    ...
    @Description(value = "URL of the link for which a click event was generated", sample = "http://example.com")
