...
public class GenerationRejectionEvent extends AbstractWebhookEvent {
    ...
    @Description(value = "Type of event this record describes", sample = "generation_rejection")
    private String type;
    ...
    @Description(value = "Substitutions applied to the template to construct this message", sample = "{\"country\":\"US\",\"gender\":\"Female\"}")
