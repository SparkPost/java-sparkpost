...
public class StatusAttributesTest {
	...
	public void testDecodeStatusAttributes() {
		Gson gson = new Gson();
		StatusAttributes statusAttrbutes = gson.fromJson(STATUS_ATTRIBUTES_JSON, StatusAttributes.class);
	...
	public void testStatusAttributesRoundtrip() {
		Gson gson = new Gson();
		StatusAttributes statusAttributes = gson.fromJson(STATUS_ATTRIBUTES_JSON, StatusAttributes.class);
