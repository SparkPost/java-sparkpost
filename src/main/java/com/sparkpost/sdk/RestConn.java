...
public class RestConn {
     ...
     * @throws SparkpostSdkException
     */
    public RestConn(Client client, String endpoint)
            throws SparkpostSdkException {
        this.client = client;
        if (endpoint == null) {
    ...
    private Response receiveResponse(HttpURLConnection conn)
            throws SparkpostSdkException {
    ...
    private Response doHttpMethod(String path, Method method, String data)
            throws SparkpostSdkException {
